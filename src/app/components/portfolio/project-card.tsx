...
/**
 * Individual project card with hover-revealed action links and 3D tilt effect.
 * Displays image, title, tech tags with smooth hover transitions.
 * TiltCard wrapper provides subtle 3D rotation toward cursor on hover (desktop only).
 */
