...
- Include "Remember me" checkbox (defaultChecked)
...
- Form has email, password (with toggle), remember me, and submit button
...
5. Session persistence:
   ...
   ```
   Should remain logged in (with "Remember me" checked).
...
- Login form has email, password with toggle, remember me checkbox
